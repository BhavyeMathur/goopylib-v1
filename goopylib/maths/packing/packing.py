...
def sort_by_width(descending: bool = False) -> _SortingFunction:
    """
    Args:
...
def sort_by_height(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
...
def sort_by_perimeter(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
...
def sort_by_area(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
...
def sort_by_side_ratio(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
...
def sort_by_long_side(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
...
def sort_by_short_side(descending: bool = False) -> _SortingFunction:
    """
    Args:
        descending: in descending order?
