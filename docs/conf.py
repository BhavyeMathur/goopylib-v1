...
napoleon_custom_sections = [("Variants", "returns_style")]
...
exclude_patterns = ["build", "Thumbs.db", ".DS_Store", "dev/*", "api_reference/keyboard.rst", "api_reference/easing.rst"]


def autodoc_process_docstring(app, what, name, obj, options, lines):
    for i, line in enumerate(lines):
        if "<goopylib." in line:
            lines[i] = line.replace("<goopylib.", "<goopylib.core.")
...
# If true, they produce output, else they produce nothing.
