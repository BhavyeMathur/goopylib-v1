...
class BBox(GraphicsObject):
    ...
    def __init__(self, p1, p2, bounds=None, style=None, fill=None, outline=None, outline_width=None,
        ...
        if not isinstance(self, gpLine.Line):
            x1 = p1.x
            x2 = p2.x
            y1 = p1.y
            y2 = p2.y
        ...
        self.bounds_object = gpRect.Rectangle(self.bounds.p1, self.bounds.p2, outline=CHROME_YELLOW, outline_width=0,
                                              cursor=self.cursor)
    ...
    def set_resizable(self, top=False, left=False, bottom=False, right=False, min_width=40, min_height=40,
        ...
        BBox.resizing_objects.append(self)
        self.bounds_thickness = bounds_width

        return self


import goopy.objects.Rectangle as gpRect
import goopy.objects.Line as gpLine
