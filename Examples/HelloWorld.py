...
title = Text(Point(0, 250), "Hello World!", text_align="center", font_colour=WHITE, font_size=30,
...
subtitle = Text(Point(250, 520), "Bhavye's 2nd program", text_align="center", font_colour=WHITE, font_size=12,
