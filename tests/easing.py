...
class EasingFunctions(unittest.TestCase):
    ...
    # Linear Easing
    def test_linear_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_linear(-1)
        with self.assertRaises(ValueError):
            self.ease_linear(1.2)
    ...
    # Polynomial Easing
    def test_poly_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_poly_in(-1)
        with self.assertRaises(ValueError):
            self.ease_poly_in(1.2)

    def test_poly_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_poly_in("test")
    
    def test_poly_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_poly_out(-1)
        with self.assertRaises(ValueError):
            self.ease_poly_out(1.2)

    def test_poly_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_poly_out("test")
            
    def test_poly_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_poly(-1)
        with self.assertRaises(ValueError):
            self.ease_poly(1.2)
    ...
    # Quadratic Easing
    def test_quad_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quad_in(-1)
        with self.assertRaises(ValueError):
            self.ease_quad_in(1.2)

    def test_quad_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quad_in("test")

    def test_quad_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quad_out(-1)
        with self.assertRaises(ValueError):
            self.ease_quad_out(1.2)

    def test_quad_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quad_out("test")

    def test_quad_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quad(-1)
        with self.assertRaises(ValueError):
            self.ease_quad(1.2)
    ...
    # Cubic Easing
    def test_cubic_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_cubic_in(-1)
        with self.assertRaises(ValueError):
            self.ease_cubic_in(1.2)

    def test_cubic_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_cubic_in("test")

    def test_cubic_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_cubic_out(-1)
        with self.assertRaises(ValueError):
            self.ease_cubic_out(1.2)

    def test_cubic_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_cubic_out("test")

    def test_cubic_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_cubic(-1)
        with self.assertRaises(ValueError):
            self.ease_cubic(1.2)
    ...
    # Quartic Easing
    def test_quart_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quart_in(-1)
        with self.assertRaises(ValueError):
            self.ease_quart_in(1.2)

    def test_quart_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quart_in("test")

    def test_quart_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quart_out(-1)
        with self.assertRaises(ValueError):
            self.ease_quart_out(1.2)

    def test_quart_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quart_out("test")

    def test_quart_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quart(-1)
        with self.assertRaises(ValueError):
            self.ease_quart(1.2)
    ...
    # Quintic Easing
    def test_quint_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quint_in(-1)
        with self.assertRaises(ValueError):
            self.ease_quint_in(1.2)

    def test_quint_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quint_in("test")

    def test_quint_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quint_out(-1)
        with self.assertRaises(ValueError):
            self.ease_quint_out(1.2)

    def test_quint_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_quint_out("test")

    def test_quint_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_quint(-1)
        with self.assertRaises(ValueError):
            self.ease_quint(1.2)
    ...
    # Quintic Easing
    def test_sin_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_sin_in(-1)
        with self.assertRaises(ValueError):
            self.ease_sin_in(1.2)

    def test_sin_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_sin_in("test")

    def test_sin_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_sin_out(-1)
        with self.assertRaises(ValueError):
            self.ease_sin_out(1.2)

    def test_sin_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_sin_out("test")

    def test_sin_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_sin(-1)
        with self.assertRaises(ValueError):
            self.ease_sin(1.2)
    ...
    # Exponential Easing
    def test_exp_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_exp_in(-1)
        with self.assertRaises(ValueError):
            self.ease_exp_in(1.2)

    def test_exp_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_exp_in("test")

    def test_exp_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_exp_out(-1)
        with self.assertRaises(ValueError):
            self.ease_exp_out(1.2)

    def test_exp_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_exp_out("test")

    def test_exp_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_exp(-1)
        with self.assertRaises(ValueError):
            self.ease_exp(1.2)
    ...
    # Circle Easing
    def test_circle_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_circle_in(-1)
        with self.assertRaises(ValueError):
            self.ease_circle_in(1.2)

    def test_circle_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_circle_in("test")

    def test_circle_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_circle_out(-1)
        with self.assertRaises(ValueError):
            self.ease_circle_out(1.2)
    ...
    # Back Easing
    def test_back_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_back_in(-1)
        with self.assertRaises(ValueError):
            self.ease_back_in(1.2)

    def test_back_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_back_in("test")

    def test_back_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_back_out(-1)
        with self.assertRaises(ValueError):
            self.ease_back_out(1.2)

    def test_back_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_back_out("test")

    def test_back_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_back(-1)
        with self.assertRaises(ValueError):
            self.ease_back(1.2)
    ...
    # Elastic Easing
    def test_elastic_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_elastic_in(-1)
        with self.assertRaises(ValueError):
            self.ease_elastic_in(1.2)

    def test_elastic_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_elastic_in("test")

    def test_elastic_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_elastic_out(-1)
        with self.assertRaises(ValueError):
            self.ease_elastic_out(1.2)

    def test_elastic_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_elastic_out("test")

    def test_elastic_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_elastic(-1)
        with self.assertRaises(ValueError):
            self.ease_elastic(1.2)
    ...
    # Bounce Easing
    def test_bounce_in_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_bounce_in(-1)
        with self.assertRaises(ValueError):
            self.ease_bounce_in(1.2)

    def test_bounce_in_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_bounce_in("test")

    def test_bounce_out_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_bounce_out(-1)
        with self.assertRaises(ValueError):
            self.ease_bounce_out(1.2)

    def test_bounce_out_type_error(self):
        with self.assertRaises(TypeError):
            self.ease_bounce_out("test")

    def test_bounce_value_error(self):
        with self.assertRaises(ValueError):
            self.ease_bounce(-1)
        with self.assertRaises(ValueError):
            self.ease_bounce(1.2)
